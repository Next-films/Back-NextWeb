...
export class GetFilmByKinopoiskIdQuery implements IQuery {
  constructor(public kpId: string) {}
}

@QueryHandler(GetFilmByKinopoiskIdQuery)
export class GetFilmByKinopoiskIdQueryHandler
  implements
    IQueryHandler<
    ...
    >
{
  constructor(
    ...
    this.logger.setContext(GetFilmByKinopoiskIdQueryHandler.name);
  }

  async execute(
    query: GetFilmByKinopoiskIdQuery,

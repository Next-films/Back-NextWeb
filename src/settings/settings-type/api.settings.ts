...
export class ApiSettings {
  ...
  @IsString()
  TELEGRAM_GATEWAY_URL: string = this.environmentVariables.TELEGRAM_GATEWAY_URL || '';

  @IsString()
  TELEGRAM_GATEWAY_TOKEN: string = this.environmentVariables.TELEGRAM_GATEWAY_TOKEN || '';

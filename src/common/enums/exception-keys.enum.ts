export enum EXCEPTION_KEYS_ENUM {
  ...
  FILM_ON_MODERATION = 'error.film_on_moderation',
  FILM_SOURCE_NOT_REPLACEABLE = 'error.film_source_not_replaceable',
  CARTOON_ON_MODERATION = 'error.cartoon_on_moderation',
  CARTOON_SOURCE_NOT_REPLACEABLE = 'error.cartoon_source_not_replaceable',

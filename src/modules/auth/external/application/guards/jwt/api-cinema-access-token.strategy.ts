...
import { API_CINEMA_ACCESS_TOKEN_GUARD_NAME } from '@/external-auth/application/guards/jwt/api-cinema-access-token.guard';
...
@Injectable()
export class ApiCinemaAccessTokenStrategy extends PassportStrategy(
  Strategy,
  API_CINEMA_ACCESS_TOKEN_GUARD_NAME,
) {
  constructor(

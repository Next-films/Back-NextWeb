...
describe('Admin cinema - films', () => {
  ...
  describe('Admin cinema - films => Remove film', () => {
    ...
    it('Admin should not remove film by id, bad input data', async () => {
      ...
      const badRequestResult = await request(app.getHttpServer())
        .delete(`${adminCinemaFilmsUrl}/filmId`)
        .set({ authorization: `Bearer ${accessToken}` })
        .expect(400);
  ...
  describe('Admin cinema - films => Show or hide film', () => {
    it('Admin should hide then show film then hide film and create moderation request', async () => {
      ...
      const moderationResult1 = await moderationFilmRepository.getAllModeration();
      ...
      const moderationResult2 = await moderationFilmRepository.getAllModeration();
      ...
      const moderationResult3 = await moderationFilmRepository.getAllModeration();
    ...
    it('Admin should hide or show film, bad input data', async () => {
      ...
      const badResult6 = await request(app.getHttpServer())
        .patch(`${adminCinemaFilmsUrl}/filmId`)
        .send({ isHidden: true, isModerate: true })
        .set({ authorization: `Bearer ${accessToken}` })
        .expect(400);
  ...
  describe('Admin cinema - films => Update film', () => {
    ...
    it('Admin should not update, bad input data', async () => {
      ...
      const badResult7 = await request(app.getHttpServer())
        .put(`${adminCinemaFilmsUrl}/filmId`)
